...
const Keyboard = () => {
  ...
  useEffect(()=>{
      const url = "https://backcomm.herokuapp.com/api/keyboard/";
  ...
  return (
    <>
    <div className='stbar'>
        <h4>STORE / ACCESORIES</h4>
    </div>
    <div className='stg'>
        <div className='side'>
        <div className='bl'>
            <h4><p>ACCESORIES: </p></h4>
            <ol>
                <p><Link to="/store/charger"><li> ChargingDevices</li></Link></p>
                <p><Link to="/store/keyboard"><li>Mics&Keyboards</li></Link></p>
                <p><Link to="/store/devices"><li>Display</li></Link></p>
                <p><Link to="#"><li>Fitness&Sports</li></Link></p>
            </ol>
        </div>
        ...
        <div className='im'>
            <img src={"https://cdn.mos.cms.futurecdn.net/EdYRZi8pmTWRfNCoBZauNe-970-80.jpg.webp"} height={"400px"} width="95%" alt={""} />
        ...
        <div className='stac'>
        {
            data.map((res)=>{
                return (
                    <div className='abc'>
                        <div > <img  src={res.ImageAsset} alt=""  width="70%" height="70%" /> </div>
                        <div> 
                            <b> {res.Title} </b>    
