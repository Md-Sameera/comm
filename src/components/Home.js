...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className='all'>
         {
            data.map((res)=>{
                return (
                    <div className='card' key={res.fp}>
                        <div > <img src={res.ImageAsset} alt=""  width="70%" height="97%" /> </div>
                        <div className='cdata'> 
                            <b> {res.Title} </b> 
                            <p> {res.Price} </p>
                        </div>
                        <button className='buy'><Link to='/cart' > <b>BUY NOW</b></Link></button>
                    </div>
                )
            })
        }
      ...
      <div className='fep'>
      <SimpleImageSlider className="sliding"
        width={600}
        height={320}
        images={images}
        showBullets={true}
